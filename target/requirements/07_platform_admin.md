...
- Type chip selector: **PDF** (retained raw + extracted to text) · **Image(s)** (retained raw + OCR via vision LLM) · **Video URL** (YouTube/Vimeo) · **Text** (paste/write markdown, or import a `.md` file — BR-EXT-049; wide split Write | Preview editor, 20,000-char cap with live counter — BR-EXT-036/048).
