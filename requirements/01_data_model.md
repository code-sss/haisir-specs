...
**BR-PARENT-004 (Link code format):** Link codes are 6-character alphanumeric uppercase strings (e.g., `A3K7M2`). Generated server-side using cryptographically secure random (`secrets.token_hex` or equivalent). Not guessable by brute force at reasonable rates.
