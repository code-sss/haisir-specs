...
| Images stored on disk at `data_dir/images/questions/`, served by URL reference — base64-at-API-layer superseded Phase 7 G3.5, see `01_data_model.md` §2.1 | Existing |
