...
> Phase 6 closed 2026-07-26 — backend:c82d466 frontend:67a883c deploy:861705b (unchanged). See progress.md "Phase 6" close-out entry.
...
- [x] **G2: Parent UI surfaces indexing pills and manual retry** — end-to-end test (2026-07-26, manual walkthrough sign-off: pill states + retry button verified in ContentItemRow, cooldown/error banner surfaced)
