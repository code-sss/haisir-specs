...
> Rough reference only. Not authoritative — details live in `target/requirements/`. Update this file only when phase ordering or scope changes significantly.
...
| 04 · Onboarding frontend | 6 screens (ON04/ON06 removed): ON01 → ON02 (student or parent) → ON03/ON05 → ON07 → ON08. |
