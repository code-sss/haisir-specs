...
> Snapshot baseline: haisir-backend `0d5305d` (feature/rag, enrollment domain + HaituService stages 1–3, 2026-06-18), haisir-frontend `ab2c3a7` (feature/rag, browse-courses + hAITU panel SonarQube fix, 2026-06-18), haisir-deploy `e57c56b` (feature/rag, all RAG env vars wired, 2026-06-15).
> Next session: `git diff 0d5305d..HEAD` in haisir-backend, `git diff ab2c3a7..HEAD` in haisir-frontend, `git diff e57c56b..HEAD` in haisir-deploy.
