...
> Snapshot baseline: haisir-backend `3b8f5f6` (G2 — teacher escalation endpoints + TeacherDoubtSummary, 2026-06-27), haisir-frontend `9e92e31` (G2 — teacher UI T06/T07 + student escalation CTA + DTO shape fix, 2026-06-27), haisir-deploy `54183f7` (Coraza ruleRemoveById fix for hAITU, 2026-06-27).
> Next session: `git diff 3b8f5f6..HEAD` in haisir-backend, `git diff 9e92e31..HEAD` in haisir-frontend, `git diff 54183f7..HEAD` in haisir-deploy.
