...
**Not yet built:** Worker process (G7 — T7.1–T7.6) ⬅ critical path for end-to-end extraction, Worker Docker Compose service (G1 — T1.1–T1.2), Parent extraction API (G6), provenance badges + inline editing (G11), worker health page (G12 / T12.1), two-section student dashboard, parent curriculum builder, link-code generation, admin sidenav Categories entry, board version display.
