...
> Snapshot baseline: haisir-backend `2686279` (feature/rag, recursive CTE topic_count fix, 2026-06-17), haisir-frontend `31062ab` (feature/rag, G8 frontend tree, 2026-06-17), haisir-deploy `e57c56b` (feature/rag, all RAG env vars wired, 2026-06-15).
> Next session: `git diff 2686279..HEAD` in haisir-backend, `git diff 31062ab..HEAD` in haisir-frontend, `git diff e57c56b..HEAD` in haisir-deploy.
