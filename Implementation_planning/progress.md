...
> Snapshot baseline: haisir-backend `6ec91ab` (feature/rag, hAITU refactor + SSE + torch CPU-only CI, 2026-06-24), haisir-frontend `47e4ec2` (feature/rag, hAITU SSE consumer + SonarQube fixes, 2026-06-24), haisir-deploy `3178451` (feature/rag, hAITU SSE APISIX route + proxy-buffering + SQLi target-exclusion, 2026-06-24).
> Next session: `git diff 6ec91ab..HEAD` in haisir-backend, `git diff 47e4ec2..HEAD` in haisir-frontend, `git diff 3178451..HEAD` in haisir-deploy.
