...
> Snapshot baseline: haisir-backend `5925a0ce` (hotfix v2026.3.5 + SonarQube, 2026-06-13), haisir-frontend `ad0c923f` (hotfix v2026.3.5 — released-grade results view, 2026-06-13), haisir-deploy `f7d63b57` (postgres-docker pgvector image, 2026-06-13).
> Next session: `git diff 5925a0ce..HEAD` in haisir-backend, `git diff ad0c923f..HEAD` in haisir-frontend, and `git diff f7d63b57..HEAD` in haisir-deploy instead of re-reading the full codebases.
