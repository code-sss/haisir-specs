...
> Snapshot baseline: haisir-backend `e92a045` (G3 — auto-close cron + doubt event notifications, 2026-06-28), haisir-frontend `23e1a45` (G3 — NotificationBell + feed page + topbar wiring, 2026-06-28), haisir-deploy `2f623f0` (G3 — APISIX notifications route, 2026-06-27).
> Next session: `git diff e92a045..HEAD` in haisir-backend, `git diff 23e1a45..HEAD` in haisir-frontend, `git diff 2f623f0..HEAD` in haisir-deploy.
