...
> Snapshot baseline: haisir-backend `9fcf14d` (essay AI grading backend complete, 2026-06-09), haisir-frontend `d0e9242` (grading_pending UI state + auto-grade checkbox, 2026-06-09), haisir-deploy `4261909` (GRADING env vars wired into worker service, 2026-06-09).
> Next session: `git diff 9fcf14d..HEAD` in haisir-backend, `git diff d0e9242..HEAD` in haisir-frontend, and `git diff 4261909..HEAD` in haisir-deploy instead of re-reading the full codebases.
