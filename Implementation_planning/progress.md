...
**Not yet built:** Worker process (G7 — T7.1–T7.6), Parent extraction API (G6), GlmOcrProvider (T4.1), PdfiumReader (T4.2), provenance badges + inline editing (G11), worker health page (G12 / T12.1), two-section student dashboard, parent curriculum builder, link-code generation, admin sidenav Categories entry, board version display.
