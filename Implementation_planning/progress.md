...
> Snapshot baseline: haisir-backend `17533c1` (feature/rag, enrollment integration test gates G1–G3 + CI wiring, 2026-06-19), haisir-frontend `7fc8811` (feature/rag, chore-only, 2026-06-19), haisir-deploy `59e42f3` (feature/rag, hAITU APISIX route + backend HAITU/EMBEDDING env vars, 2026-06-19).
> Next session: `git diff 17533c1..HEAD` in haisir-backend, `git diff 7fc8811..HEAD` in haisir-frontend, `git diff 59e42f3..HEAD` in haisir-deploy.
