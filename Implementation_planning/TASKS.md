...
- [ ] **G7: Phase acceptance** — T7.2 [frontend] suites green + manual walkthrough record (depends on T7.1 + all frontend leaf tasks of G1–G6) (2026-07-11: T7.1 [backend] done — both journey variants written and green locally; T7.2 [frontend] suites-green VERIFIED 2026-07-11 — `pnpm typecheck` clean, `pnpm test:coverage` 210 files / 3606 tests passed / 100% coverage [stmts 5619/5619, branches 4000/4000, funcs 1619/1619, lines 5210/5210]; manual browser walkthrough record still pending — deferred per user direction "leave it")
